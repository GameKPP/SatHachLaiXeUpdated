...
create procedure sp_HocVien_Update
(
@MaHV varchar(10) output ,
@TenHV nvarchar(30),
@HoHV nvarchar(30),
...
as
update TTHOCVIEN set TenHV=@TenHV,HoHV=@HoHV,NgaySinh=@NgaySinh,SoCMND=@SoCMND,NgayCapCMND=@NgayCapCMND,SDT=@SDT,DiaChi=@DiaChi,DiemTH=@DiemTH,NgayDK=@NgayDK
where MaHV=@MaHV
