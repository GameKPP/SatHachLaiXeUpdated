                ...
                using (IDbConnection db = new SqlConnection(ConfigurationManager.ConnectionStrings["cn"].ConnectionString))
                {
                    ...
                    if (obj != null)
                    {
                        if (obj.MatKhau == txtPassword.Text)//True
                        {
                            ...
                            {
                                this.Hide();
                                frm.metroTile13.Visible = true;
                                frm.metroTile8.Visible = true;
                                frm.metroTile10.Visible = true;
                                frm.metroTile15.Visible = true;
                                frm.metroTile9.Visible = true;
                                frm.metroTile11.Visible = true;
                                frm.ShowDialog();
